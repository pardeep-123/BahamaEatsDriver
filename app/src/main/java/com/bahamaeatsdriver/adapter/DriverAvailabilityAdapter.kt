...
class DriverAvailabilityAdapter(var context: Context, val daysList: ArrayList<Body>, val listener: OnDriverAvailabilitySelection) : RecyclerView.Adapter<DriverAvailabilityAdapter.MyViewHolder>() {

    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): MyViewHolder {
        val itemView = LayoutInflater.from(viewGroup.context).inflate(R.layout.driver_availability_row_layout, viewGroup, false)
