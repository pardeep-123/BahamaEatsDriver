...
data class DriverTipsAndEarning(
    @SerializedName("body")
    val body: Body,
    @SerializedName("code")
    val code: Int,
...
data class Body(
    ...
    val rideRequest: ArrayList<RideRequest>
)
...
data class Deliverydeduction(
    ...
    val deliveryDeduction: Int,
    @SerializedName("delivery_fee")
    val deliveryFee: Double,
    @SerializedName("delivery_received")
    val deliveryReceived: Double,
