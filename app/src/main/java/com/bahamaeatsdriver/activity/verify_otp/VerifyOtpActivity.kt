package com.bahamaeatsdriver.activity.verify_otp
...
class VerifyOtpActivity : AppCompatActivity(), TextWatcher, View.OnClickListener,
    ...
    private fun startTimer() {
        val countDownTimer = object : CountDownTimer(60000, 1000) {
            ...
            override fun onTick(millisUntilFinished: Long) {
                ...
                tv_resend_otp.isClickable = false
                tv_resend_otp.setTextColor(ContextCompat.getColor(this@VerifyOtpActivity, R.color.colorTextView))
            }
